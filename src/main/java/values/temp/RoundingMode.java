 ...
 * {@code DecConducting} number with the specified value, forming a
 ...
 * calling {@link DecConducting#round round} on this number with the
 ...
 * enumeration of rounding mode constants in {@link DecConducting}
 * ({@link DecConducting#ROUND_UP}, {@link DecConducting#ROUND_DOWN},
 * etc. ).
 *
 * @see     DecConducting
 * @see     MathContext
...
public enum RoundingMode {
    ...
    DOWN(DecConducting.ROUND_DOWN),
         ...
         *</table>
         */
    CEILING(DecConducting.ROUND_CEILING),
         ...
         *</table>
         */
    FLOOR(DecConducting.ROUND_FLOOR),
         ...
         *</table>
         */
    HALF_UP(DecConducting.ROUND_HALF_UP),
         ...
         *</table>
         */
    HALF_DOWN(DecConducting.ROUND_HALF_DOWN),
         ...
         *</table>
         */
    HALF_EVEN(DecConducting.ROUND_HALF_EVEN),
         ...
         *</table>
         */
    UNNECESSARY(DecConducting.ROUND_UNNECESSARY);

    // Corresponding DecConducting rounding constant
    final int oldMode;

    /**
     * Constructor
     *
     * @param oldMode The {@code DecConducting} constant corresponding to
     *        this mode
     */
     ...
     * legacy integer rounding mode constant in {@link DecConducting}.
     *
    ...
    public static RoundingMode valueOf(int rm) {
        ...
        case DecConducting.ROUND_UP:
            return UP;

        case DecConducting.ROUND_DOWN:
            return DOWN;

        case DecConducting.ROUND_CEILING:
            return CEILING;

        case DecConducting.ROUND_FLOOR:
            return FLOOR;

        case DecConducting.ROUND_HALF_UP:
            return HALF_UP;

        case DecConducting.ROUND_HALF_DOWN:
            return HALF_DOWN;

        case DecConducting.ROUND_HALF_EVEN:
            return HALF_EVEN;

        case DecConducting.ROUND_UNNECESSARY:
            return UNNECESSARY;
